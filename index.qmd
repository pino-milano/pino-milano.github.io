...
::: {.g-col-12 .g-col-md-6}
[![](assets/figures/phase_trans.jpg){fig-alt="Phase transitions and molecular organization"}](phase-transitions.qmd)

### [Phase Transitions and Molecular Organization](phase-transitions.qmd)

Solid–liquid and liquid-crystalline transitions, polymorphism, metastability, and history-dependent molecular organization in complex materials.
:::

::: {.g-col-12 .g-col-md-6}
[![](assets/figures/carbonblack_macromolecules.jpg){fig-alt="Molecular organization at a carbon black polymer interface"}](interfaces-nanomaterials.qmd)

### [Interfaces and Nanomaterials](interfaces-nanomaterials.qmd)
Polymer composites, Brushes, Hierarchical Fillers
:::

::: {.g-col-12 .g-col-md-6}

[![](assets/figures/biolipids.jpg){fig-alt="microbial lipids"}](interfaces-nanomaterials.qmd)
